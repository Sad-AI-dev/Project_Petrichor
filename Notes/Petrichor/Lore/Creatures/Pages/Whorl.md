...
[[The Survivor]] likely encountered the [[Whorl]] in the [[Sunken Tomb]], on their 8th day on [[Petrichor V]], following the events of the [[UES Contact Light]].
[[The Survivor]] was attacked by the [[Whorl]] slamming its large body into their armor. They record that if it wasn't for their small tube of `polymer sealant` from the `astrotrain`, their suit's air lock would have likely given out, resulting in their death.

The term `astrotrain` may be a term to describe the category of intergalactic ships that the [[UES Contact Light]] belongs to.

The [[Whorl]] resembles earth's Nautili, but are much larger and make use of a constant stream of a gas to propel themselves.
