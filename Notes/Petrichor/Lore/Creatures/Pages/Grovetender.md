![[Grovetender.png|256]]
*Grovetender* is a monster from *Risk of Rain 2*, belonging to the [[Wisp Family]].
...
<span class="lore-text"><span class="lore-text-dark"><span class="center-inline">Wisp Cultivator</span></span></span>
# <span class="lore-title-inline">Lore</span>
<span class="lore">GATHER, LITTLE ONES. ALL HAVE DONE EXCELLENT JOBS TENDING TO OUR GARDEN – I COULD NOT BE MORE PROUD.
...
NOW, I BELIEVE IT IS TIME TO RETURN TO WORK. COME, LITTLE ONES! LET US TEND TO OUR GARDEN.</span>
# <span class="lore-title-inline">Notes</span>
This log contains a monologue spoken by a [[Grovetender]] to a group of [[Lesser Wisp|Lesser Wisps]].

This monologue takes place in [[The Garden]], where the [[Grovetender]] and a group of [[Lesser Wisp|Lesser Wisps]] have been tending to it. They take a break and the [[Grovetender]] suggests to tell a story about [[The Garden]] to the [[Lesser Wisp|Lesser Wisps]].

It is mentioned that the [[Grovetender]] believes that they must satisfy the curiosity of the [[Lesser Wisp|Lesser Wisps]]. Considering that the [[Lesser Wisp]] log shows that [[Edelwood]] bark is used in their creation for curiosity, it makes sense that the [[Lesser Wisp|Lesser Wisps]] would need their curiosities fulfilled.
