![[Halcyon_Seed.webp|128]]

*Halcyon Seed* is a **<span class="yellow-bg">boss</span>** item from Risk of Rain 2.
For all items, see the [[Items.canvas|Items]] page.

### <span class="lore-title-inline">Pickup Description</span>
<span class="lore-text">Summon Aurelionite during the Teleporter event.</span>
# <span class="lore-title-inline">Lore</span>
<span class="lore">Brother, what is this...? Why is it misshapen and weak? Was there an error in my design?
...
The log also reveals that without [[Providence|Providence's]] help, [[Mithrix]] cannot create servants at the same level of power. This seems to be in reference to [[Mithrix]] struggling to manipulate soul.
