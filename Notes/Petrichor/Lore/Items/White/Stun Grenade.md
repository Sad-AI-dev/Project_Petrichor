![[128px-Stun_Grenade.webp|128]]
*Stun Grenade* is a **<span class="gray-bg">white</span>** item from Risk of Rain 2.
For all items, see the [[Items.canvas|Items]] page.

### <span class="lore-title-inline">Pickup Description</span>
<span class="lore-text">Chance to stun on hit.</span>
# <span class="lore-title-inline">Lore</span>
<span class="lore"><span class="lore-mono">//--AUTO-TRANSCRIPTION FROM CARGO BAY 2 OF UES [Redacted] --//</span>
...
They were both admitted to the medical bay shortly after.</span>
# <span class="lore-title-inline">Notes</span>
This log shows a conversation between 2 survivors on inventory duty in the [[UES [REDACTED]|UES [REDACTED].]]

The conversation takes place after the [[UES [REDACTED]|UES [REDACTED] ]]landed on [[Petrichor V]]. Various items had been recovered from the [[UES Contact Light]].

The stun grenade item is an old flashbang. This model is no longer produced at this point in time.

This log also establishes that the [[UES Contact Light]] was shipping millions of items from all over the galaxy.
