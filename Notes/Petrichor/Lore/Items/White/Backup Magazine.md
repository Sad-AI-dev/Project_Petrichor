...
<span class="lore-text">Add an extra charge of your Secondary skill.</span>
# <span class="lore-title-inline">Lore</span>
<span class="lore">Order: Ammo Magazine, Standard Ammunition (45mm Rounds)
Tracking Number: 05***********
...
The backup magazine is being shipped to the [[UES Port Trailing Comet]]. It is possible that the \[REDACTED\] Captain is in reference to the [[Captain]].

# <span class="lore-title-inline">Lore</span>
<span class="lore"><span class="yellow">Shipping Details:</span>
  <span class="lore-text-dark">Tracking Number: 177***********
...
1803                                               High Priority
Combat Zone                                 <span class="lore-text-dark">Estimated Delivery:</span>
Venus                                            9/12/2056</span>
# <span class="lore-title-inline">Notes</span>
This item is being shipped to [[Venus]].

It appears that there is an active conflict on [[Venus]]. A sort of peace treatise has been established by a small group of individuals referred to as `big-wigs`. Due to this, it's hard to send militaristic aid to those fighting in the war. There is no such restriction on medication.
