![[Jade_Elephant.webp|128]]

*Jade Elephant* is an **<span class="orange-bg">Equipment</span>** item from Risk of Rain 2.
For all items, see the [[Items.canvas|Items]] page.

### <span class="lore-title-inline">Pickup Description</span>
<span class="lore-text">Gain massive armor for 5 seconds.</span>
# <span class="lore-title-inline">Lore</span>
<span class="lore">Excerpt from the folk tale "Clean as Jade":
...
Determination and resolve had essentially been carved into the very spirit of the ones who, just moments ago, were clutching their farming implements and make-shift weapons with trembling hands. The attack was repelled that day. The Emperor’s army told stories about their metal weapons bouncing off the cloth of commoners. This inspiring encounter spread to other villages and...”</span>
# <span class="lore-title-inline">Notes</span>
This log is an excerpt from the folk tale [[Clean as Jade]].

It seems the [[Jade Elephant]] is a reference to this folk tale, where a woman created a giant jade sculpture depicting an elephant. This sculpture emboldened the villagers and allowed them to fend off against the impeding army of the Emperor.
