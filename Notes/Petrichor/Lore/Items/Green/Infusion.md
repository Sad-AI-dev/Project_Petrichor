...
<span class="lore-text">Killing an enemy permanently increases your maximum health, up to 100</span>
# <span class="lore-title-inline">Lore</span>
<span class="lore">Order: Infusion
Tracking Number: 768******
...
You can add whatever blood sample you want, as far as I know. Just make sure you take the pills that allow the body to accept the new blood, or your body will reject the cross-species infusion. Remember that sampling from other animals is a great basis for experimentation!</span>
